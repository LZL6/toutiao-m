<template>
    <div class="user-profile">
        ...
        <van-popup v-model="isUpdateNameShow" style="height:100%" position="bottom">
            <UpdateName @close="isUpdateNameShow = false" v-model="user.name" v-if="isUpdateNameShow" />
        </van-popup>
        <!-- /编辑昵称 -->
        ...
        <van-popup v-model="isUpdatePhotoShow" position="bottom" style="height:100%;">
            <UpdatePhoto :img="img" @close="isUpdatePhotoShow = false" v-if="isUpdatePhotoShow"
