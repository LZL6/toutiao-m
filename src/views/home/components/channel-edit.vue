    ...
    <div class="channel-edit">
        ...
        <van-grid class="my-grid" :gutter="10">
            <van-grid-item class="grid-item" v-for="(channel, index) in myChannels" :key="channel.id"
                ...
                <van-icon v-show="isEdit && !flexdChannels.includes(channel.id)" slot="icon" name="clear"></van-icon>
        ...
        <van-grid class="recommend-grid" :gutter="10">
            <van-grid-item class="grid-item" v-for="channel in recommendChannels" :key="channel.id" icon="plus"
